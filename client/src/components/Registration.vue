        ...
        <div class="container">
          ...
          <div class="input_box">
            <input type="text" placeholder="Введите логин" name="login" id="login" v-model="login" required>
              ...
              <div class="password">
                <input :type="showPassword_two" v-model="password_two" id="password-input" placeholder="Введите пароль повторно" name="password">
                <a @click="toggleShow_two" class="password-control"></a>
              </div>
            </div>
            <div class="btn"></div><button type="button" class="registerbtn" @click="register">Зарегистрироваться</button>
            </div>
